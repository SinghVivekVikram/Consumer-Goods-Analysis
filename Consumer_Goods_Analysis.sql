/*1. Provide the list of markets in which customer "Vivir Industries" operates its
business in the APAC region.*/

SELECT DISTINCT market as Markets_list, customer as Customer_name, region as Region FROM dim_customer
WHERE customer = "Vivir Industries" AND region = "APAC";
...
WHERE c.customer = "Vivir Industries"
GROUP BY Month,Year
ORDER BY Month,Year;
